...
new class extends Component {
    ...
    {
        // The event model should be passed as a prop from the parent.
    ...
    // Re-adding the necessary methods for the Blade template to function
    ...
    <div class="relative bg-slate-900 h-[400px] md:h-[500px] z-0">
        ...
        <div class="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/50 to-transparent flex items-end">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pb-12">
                ...
                <span class="inline-block {{ $this->event?->start_date?->isFuture() ? 'bg-green-600' : 'bg-slate-500' }} text-white px-4 py-1 rounded-full text-sm font-semibold mb-4">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-base font-semibold text-slate-900 dark:text-white">
                                    {{ $this->event?->start_date?->format('l, F j, Y') ?? Carbon::now()->format('l, F j, Y') }}
                                </p>
                            </div>
                        </div>
