...
/**
 * Event detail block - Volt component. Unica fonte di verità: Event.
 * mount() risolve event da event ?? item ?? slug0 e popola le proprietà pubbliche per la vista.
 * Usato da page-content con @livewire('events.detail', ...) quando il blocco ha "livewire": "events.detail"
 */
                        ...
                        <div class="aspect-video bg-slate-100 dark:bg-slate-700 rounded-lg flex items-center justify-center border-2 border-dashed border-slate-300 dark:border-slate-600">
                            <div class="text-center text-slate-500 dark:text-slate-400">
                                <svg class="w-16 h-16 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 01-.553-.894L15 4m0 13V4m0 0L9 7" />
                                </svg>
                ...
                <section class="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-8 border border-slate-200 dark:border-slate-700">
                    ...
                    <div class="flex items-center">
                        <div class="flex -space-x-3">
                            @php $maxDisplay = min($this->attendeesCurrent, 8); @endphp
