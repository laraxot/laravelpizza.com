...
<section class="py-12 md:py-16 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white transition-colors" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div x-show="filteredEvents.length === 0" x-cloak class="text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('meetup::events.no_events_found') }}</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('meetup::events.check_back_later') }}</p>
        </div>
    </div>
</div>
