        ...
        <form wire:submit="submit" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input
                            ...
                            id="password"
                            wire:model="password"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-red-500 focus:border-transparent transition-colors pr-12"
            ...
            <div class="space-y-5">
                ...
                <fieldset class="space-y-3" aria-label="{{ __('gdpr::register.consents.title') }}">
                    ...
                    <label
                        class="flex items-start gap-3 p-4 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-red-300 dark:hover:border-red-600 transition-all cursor-pointer group bg-gray-50 dark:bg-gray-900/50"
                    ...
                    >
                        ...
                        <div class="flex-1 space-y-1">
                            ...
                            <a href="{{ \LaravelLocalization::localizeUrl('/privacy') }}" 
                               ...
                               class="inline-flex items-center gap-1 text-xs text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 rounded">
                    ...
                    @error('privacy_accepted')
                        <p class="ml-8 text-sm text-red-600 dark:text-red-400 flex items-center gap-1" role="alert">
            ...
            <div class="space-y-4">
                ...
                <label
                    class="flex items-start gap-3 p-4 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-orange-300 dark:hover:border-orange-600 transition-all cursor-pointer group bg-gray-50 dark:bg-gray-900/50 opacity-80"
                ...
                >
                    <div class="relative flex-shrink-0 mt-0.5">
                        <input
                            ...
                            class="peer h-5 w-5 rounded border-gray-300 text-orange-500 focus:ring-orange-500 dark:border-gray-600 dark:bg-gray-700"
                        >
