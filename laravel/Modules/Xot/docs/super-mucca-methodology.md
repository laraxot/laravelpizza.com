...
- **Branding & Design**: Logos and icons must be **symbolic/abstract** and **minimalist**. Literal representations (e.g., detailed pizza slices) are considered "low-end" and are forbidden. Professional, "premium" design relies on geometric simplicity and line-art (Lucide-style).
