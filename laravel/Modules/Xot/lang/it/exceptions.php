...
return [
  ...
  'frontend' => [
    'auth' => [
      'confirmation' => [
        ...
        'resend' => 'Il tuo account non è confermato. Per cortesia clicca sul link di conferma nell\'email che ti abbiamo mandato, o <a href="route">clicca qui</a> per rimandare l\'email di conferma.',
  ...
  'actions' => [
    'create' => [
      'label' => 'Crea Exceptions',
    ],
    'edit' => [
      'label' => 'Modifica Exceptions',
    ],
    'delete' => [
