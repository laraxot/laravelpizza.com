...
Based on research of multiple Laravel Folio + Volt repositories and official documentation, this document outlines the best practices and patterns for implementing Folio + Volt in the Laravel Pizza Meetups project.
...
## Implementation for Laravel Pizza Meetups
...
### Middleware Strategy
- Public pages (homepage, events list): No middleware
- User dashboard/profile: `middleware(['auth'])`
- Event creation/editing: `middleware(['auth', 'verified'])`

### Component Strategy
- Use inline `@volt` components for page-specific interactions
- Use Blade components for reusable UI elements
- Use full Livewire components for complex reusable functionality
