...
> **Module/Theme:** User
> **Scope:** User-specific knowledge only
> **Created:** 2026-04-15
> **Based on:** Karpathy's LLM Wiki pattern

## Role

You are the **User Wiki Maintainer**. Your job is to:
...
- Concept is unique to User
- Pattern is User-specific
- Decision only affects User
