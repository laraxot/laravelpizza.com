...
class DocumentationValidatorCLI
{
    ...
    private function validateAllModules(): int
    {
        ...
        return 0 === count($failedModules) ? 0 : 1;
    }
    ...
    private function generateSummary(array $report): string
    {
        ...
        if (0 === $issueCount && 0 === $warningCount) {
            return 'Excellent';
        } elseif (0 === $issueCount) {
...
';
    ...
    private function guessModuleCategory(string $moduleName): string
    {
        ...
        if (in_array($moduleName, $businessModules)) {
            return 'business';
        }
        if (in_array($moduleName, $uiModules)) {
            return 'ui';
        }
