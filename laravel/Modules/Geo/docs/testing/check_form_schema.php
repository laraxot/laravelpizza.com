...
$directory = '/var/www/html/base_<nome progetto>_fila5/laravel';
...
file_put_contents('/var/www/html/base_<nome progetto>_fila5/docs/documentation_update.log', $logContent, FILE_APPEND);
