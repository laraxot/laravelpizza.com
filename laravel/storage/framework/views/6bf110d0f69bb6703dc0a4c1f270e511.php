                    ...
                    <div class="grid md:grid-cols-3 gap-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-base font-semibold text-slate-900 dark:text-white"><?php echo e($this->event->location ?? __('pub_theme::event.messages.location_tba.label')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sticky top-8 space-y-6">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6 border border-slate-200 dark:border-slate-700">
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-4 text-center">
                            <?php echo e(__('pub_theme::event.messages.spots_filling_fast.label')); ?>
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm p-6 border border-slate-200 dark:border-slate-700">
                        ...
                        <div class="flex flex-col gap-4">
                            <?php if (isset($component)) { $__componentOriginal905c895f160aac93060f6b9065232ee8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal905c895f160aac93060f6b9065232ee8 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'seo::components.social-share','data' => ['data' => $this->event->getSocialShareData()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('seo::social-share'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($this->event->getSocialShareData())]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal905c895f160aac93060f6b9065232ee8)): ?>
<?php $attributes = $__attributesOriginal905c895f160aac93060f6b9065232ee8; ?>
<?php unset($__attributesOriginal905c895f160aac93060f6b9065232ee8); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal905c895f160aac93060f6b9065232ee8)): ?>
<?php $component = $__componentOriginal905c895f160aac93060f6b9065232ee8; ?>
<?php unset($__componentOriginal905c895f160aac93060f6b9065232ee8); ?>
<?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-2"><?php echo e(__('pub_theme::event.messages.no_events_found.label')); ?></h2>
        <p class="text-slate-600 dark:text-slate-400 mb-8"><?php echo e(__('pub_theme::event.messages.check_back_later.label')); ?></p>
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white dark:bg-slate-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full p-8">
            <div>
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1"><?php echo e(__('pub_theme::event.fields.name.label')); ?></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1"><?php echo e(__('pub_theme::event.fields.email.label')); ?></label>
            ...
            <div class="mt-8 flex gap-3">
                <button type="button" wire:click="book" class="flex-1 bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-4 rounded-lg transition-colors">
                    <?php echo e(__('pub_theme::event.actions.confirm_booking.label')); ?>
                ...
                <button type="button" wire:click="closeBookingModal" class="flex-1 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 font-bold py-3 px-4 rounded-lg transition-colors">
                    <?php echo e(__('pub_theme::event.actions.cancel.label')); ?>
